## About effect of Projection Matrix left and right multiplies scale or uniformity diagonal matrix 关于Projection Matrix 分别左乘和右乘Scale Matrix或uniformity diagonal matrix 的效果
